                    ...
                    if let Some(handle) = handle {
                        ...
                        let res = __asyncify_light(
                            ...
                            async {
                                ...
                                // XXX: flushing on nonblocking streams may fail, but we have no way to determine whether
                                //      the nonblocking mode is turned on (they are tied together in a terminal)
                                if is_stdio {
